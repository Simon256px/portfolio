...
*Princesse Mononoké* a demandé **144 000 cellulos**. Hayao Miyazaki [en a personnellement redessiné ou retouché environ 80 000](https://fr.wikipedia.org/wiki/Princesse_Mononok%C3%A9), soit **55 % du film**, à la main.
...
Le 26 mars 2025, OpenAI ouvre la génération d'images dans ChatGPT. En quelques jours, le web se couvre de photos converties « en style Ghibli », au point que [Sam Altman annonce que ses GPU sont en train de fondre](https://fortune.com/2025/03/28/sam-altman-chatgpt-gpus-melting-ai-images/). Il change lui-même sa photo de profil.
...
La technologie montrée n'est **pas** un générateur d'images. C'est [un système d'apprentissage automatique appliqué au mouvement](https://www.animenewsnetwork.com/interest/2016-12-09/hayao-miyazaki-calls-ai-cg-animation-presentation-an-insult-to-life-itself/.109717) : un modèle humain à qui la machine a appris à se déplacer vite en ignorant la notion de douleur. Résultat à l'écran : une créature qui rampe en s'appuyant sur sa tête, façon zombie.
...
Le Japon a inscrit dans son code de la propriété intellectuelle un **article 30-4** qui autorise l'exploitation d'œuvres protégées à des fins dites de « non-jouissance ». En clair : [entraîner un modèle sur des œuvres sous droits est licite sans autorisation](https://www.bunka.go.jp/english/policy/copyright/pdf/94055801_01.pdf), parce que l'entraînement n'est pas de la consommation de l'œuvre. C'est l'un des régimes les plus ouverts de la planète, et il a été voulu comme tel.
...
Regarde d'ailleurs la ligne qu'OpenAI a choisie, elle : la société a déclaré refuser de générer dans le style d'un **artiste vivant identifié**, tout en autorisant [les « styles de studio plus larges »](https://www.fastcompany.com/91308222/openais-studio-ghibli-style-images-renew-the-debate-over-ai-and-copyright). Lis la règle à l'envers : plus il y a de personnes derrière une esthétique, moins elle est protégée. Un studio de trois cents animateurs est plus copiable qu'un dessinateur seul. C'est le contraire exact de là où se trouve le travail.

C'est le même réflexe que celui que je recommandais [pour les licences de modèles](https://simoncourtois.com/journal/open-weight-ou-open-source/) : ne lis pas l'annonce, lis la règle. Celle-ci dit quelque chose d'assez précis sur ce qu'on considère comme appropriable.
...
Le générateur n'a volé aucun dessin. **Il a rendu impossible de savoir, en regardant, si quelqu'un a travaillé** — et c'est exactement le mécanisme que je décrivais à propos [de la farine du boulanger](https://simoncourtois.com/journal/la-farine-du-boulanger/) : on ne t'enlève pas une chose, on t'enlève la capacité de voir l'autre moitié de la transaction.
...
**Ghibli n'a pas su transmettre sa méthode, et l'IA n'y est pour rien.** Le 21 septembre 2023, le studio [cède 42,3 % de son capital à la chaîne Nippon TV](https://unseen-japan.com/studio-ghibli-surprise-acquisition-by-nippon-tv/), qui en prend le contrôle. La raison est dite explicitement dans le communiqué commun : Miyazaki a 82 ans, le producteur Suzuki en a 75, et il n'y a pas de successeur. Goro Miyazaki, le fils, a refusé, jugeant qu'il serait difficile de porter seul la direction du studio.
...
Ensuite, la réponse est venue d'ailleurs et beaucoup plus tard. Fin octobre 2025, la **CODA** — l'association japonaise de distribution des contenus à l'étranger — adresse une lettre à OpenAI au nom de ses membres, dont [Ghibli, Square Enix, Bandai Namco, Sony Music, Toei Animation et Kadokawa](https://www.journaldugeek.com/2025/11/04/ghibli-et-lia-les-japonais-tapent-du-poing-sur-la-table-pour-faire-retirer-leurs-oeuvres-de-sora-2-et-dall-e/), demandant le retrait de leurs œuvres de Sora 2 et de DALL·E.
...
Et si tu te sens indigné en lisant ça, ou au contraire enthousiaste devant ce que la machine sait faire, [souviens-toi que c'est le même affect](https://simoncourtois.com/journal/spinoza-a-l-epreuve-de-l-ia/), né de la même image incertaine de l'avenir. Les 80 000 dessins, eux, ont réellement été faits.
